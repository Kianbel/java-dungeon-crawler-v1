...
public class MothFSM extends StandardMonsterFSM<MothFSM.STATE> {
    public enum STATE {
        IDLE,
        FOLLOW,
        ATTACK,
    ...
    public MothFSM(Monster owner) {
        super(owner);
        setupInitialState();
    }

    @Override protected int getFollowRange() {return 12;}
    @Override protected double getFollowChance() {return 0.5;}
    @Override protected double getBackOffChance() {return 1;}
